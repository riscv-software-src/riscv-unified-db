...
Description::
The xref:insts:fadd_s.adoc#udb:doc:inst:fadd_s[fadd.s] instructions performs single-precision floating-point addition between `xs1` and `xs2`
...
Synopsis::
Floating-Point Move from Integer Register to Single-Precision Register
...
Synopsis::
Floating-Point Move from Single-Precision Register to Integer Register
