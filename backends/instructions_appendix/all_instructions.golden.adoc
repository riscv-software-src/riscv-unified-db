...
Synopsis::
Floating-Point Quiet Less Than Quad-Precision
...
Synopsis::
Floating-Point Fused Multiply-Add Quad-Precision
...
Synopsis::
Floating-Point Maximum-Number with _NaN_ Handling Quad-Precision
...
Synopsis::
Floating-Point Minimum-Number with _NaN_ Handling Quad-Precision
...
Synopsis::
Floating-Point Fused Multiply-Subtract Quad-Precision
...
Synopsis::
Floating-Point Move Upper 64 Bits of Quad-Precision to Integer Register
...
Synopsis::
Floating-Point Move Integer Pair Quad-Precision
...
Synopsis::
Floating-Point Fused Negate-Multiply-Add Quad-Precision
...
Synopsis::
Floating-Point Fused Negate-Multiply-Subtract Quad-Precision
...
Synopsis::
Floating-Point Round-to-Integral-Exact Quad-Precision
...
Synopsis::
Floating-point Sign-Injection Quad-Precision
