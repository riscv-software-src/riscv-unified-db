...
hierarchy. NTL.ALL is encoded as ADD x0, x0, x5.
...
temporal locality within the capacity of the innermost level of private cache
in the memory hierarchy. NTL.P1 is encoded as ADD x0, x0, x2.
...
temporal locality within the capacity of any level of private cache in the memory
hierarchy. NTL.PALL is encoded as ADD x0, x0, x3.
...
temporal locality within the capacity of the innermost level of shared cache
in the memory hierarchy. NTL.S1 is encoded as ADD x0, x0, x4.
