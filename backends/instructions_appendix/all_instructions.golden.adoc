...
Description::
xref:insts:fclass_d.adoc#udb:doc:inst:fclass_d[fclass.d] is defined analogously to its single-precision counterpart, but operates on double-precision operands.
...
is true and clear otherwise. All other bits in _xd_ are cleared. Note that exactly one bit in _xd_ will be set.
...
Description::
xref:insts:fcvt_d_l.adoc#udb:doc:inst:fcvt_d_l[fcvt.d.l] converts a 64-bit signed integer, in integer register _xs1_ into a double-precision
...
Description::
xref:insts:fcvt_d_lu.adoc#udb:doc:inst:fcvt_d_lu[fcvt.d.lu] converts to or from a 64-bit unsigned integer, _xs1_ into a double-precision
floating-point number in floating-point register _fd_.
...
major opcode space and both the source and destination are floating-point registers. The _xs2_ field
encodes the datatype of the source, and the _fmt_ field encodes the datatype of the destination.
...
Description::
xref:insts:fcvt_d_w.adoc#udb:doc:inst:fcvt_d_w[fcvt.d.w] converts a 32-bit signed integer, in integer register _xs1_ into a double-precision
floating-point number in floating-point register _fd_. Note xref:insts:fcvt_d_w.adoc#udb:doc:inst:fcvt_d_w[fcvt.d.w] always produces an exact
...
Description::
xref:insts:fcvt_d_wu.adoc#udb:doc:inst:fcvt_d_wu[fcvt.d.wu] converts a 32-bit unsigned integer in integer register _xs1_ into a double-precision
floating-point number in floating-point register _fd_. Note xref:insts:fcvt_d_wu.adoc#udb:doc:inst:fcvt_d_wu[fcvt.d.wu] always produces an exact
result and is unaffected by rounding mode.
...
Description::
xref:insts:fcvt_l_d.adoc#udb:doc:inst:fcvt_l_d[fcvt.l.d] converts a double-precision floating-point number in floating-point register _fs1_
...
Description::
xref:insts:fcvt_lu_d.adoc#udb:doc:inst:fcvt_lu_d[fcvt.lu.d] converts a double-precision floating-point number in floating-point register _fs1_
...
xref:insts:fcvt_s_d.adoc#udb:doc:inst:fcvt_s_d[fcvt.s.d] converts a double-precision floating-point number to a single-precision floating-point number.
 ...
 registers. The _xs2_ field encodes the datatype of the source, and the _fmt_ field encodes the datatype
 of the destination. xref:insts:fcvt_s_d.adoc#udb:doc:inst:fcvt_s_d[fcvt.s.d] rounds according to the _rm_ field.
...
Description::
xref:insts:fcvt_w_d.adoc#udb:doc:inst:fcvt_w_d[fcvt.w.d] converts a double-precision floating-point number in floating-point register _fs1_ to a
...
Description::
xref:insts:fcvt_wu_d.adoc#udb:doc:inst:fcvt_wu_d[fcvt.wu.d] converts a double-precision floating-point number in floating-point register _fs1_ to an
...
with the _xs2_ field set to 8 and the _rm_ field set to 1 (RTZ). Other _rm_ values are reserved.
...
Description::
xref:insts:fdiv_d.adoc#udb:doc:inst:fdiv_d[fdiv.d] performs the double-precision floating-point division of _fs1_ by _fs2_. It is defined analogously
...
Description::
xref:insts:feq_d.adoc#udb:doc:inst:feq_d[feq.d] writes 1 to _xd_ if _fs1_ and _fs2_ are equal, and 0 otherwise. It is defined analogously to its
...
Description::
xref:insts:fld.adoc#udb:doc:inst:fld[fld] instruction loads a double-precision floating-point value from memory into floating-point
...
Description::
xref:insts:fle_d.adoc#udb:doc:inst:fle_d[fle.d] writes 1 to _xd_ if _fs1_ is less than or equal to _fs2_, and 0 otherwise. It is defined
...
Description::
xref:insts:fleq_d.adoc#udb:doc:inst:fleq_d[fleq.d] is defined like the xref:insts:fle_d.adoc#udb:doc:inst:fle_d[fle.d] instruction, except that quiet NaN inputs do not cause
...
Description::
xref:insts:fli_d.adoc#udb:doc:inst:fli_d[fli.d] instruction loads one of 32 double-precision floating-point constants, encoded in the _xs1_
field, into floating-point register _fd_. xref:insts:fli_d.adoc#udb:doc:inst:fli_d[fli.d] is encoded like xref:insts:fli_s.adoc#udb:doc:inst:fli_s[fli.s], but with _fmt_ set to D.
...
Description::
xref:insts:flt_d.adoc#udb:doc:inst:flt_d[flt.d] writes 1 to _xd_ if _fs1_ is less than _fs2_, and 0 otherwise. It is defined analogously to its
...
Description::
xref:insts:fltq_d.adoc#udb:doc:inst:fltq_d[fltq.d] is defined like the xref:insts:flt_d.adoc#udb:doc:inst:flt_d[flt.d] instruction, except that quiet NaN inputs do not cause
the invalid operation exception flag to be set.
...
Description::
xref:insts:fmadd_d.adoc#udb:doc:inst:fmadd_d[fmadd.d] multiplies the values in _fs1_ and _fs2_, adds the value in _fs3_, and writes the final result to _fd_.
...
Description::
xref:insts:fmax_d.adoc#udb:doc:inst:fmax_d[fmax.d] writes larger of _fs1_ and _fs2_ to _fd_. For the purposes of this instruction, the value
...
Description::
xref:insts:fmaxm_d.adoc#udb:doc:inst:fmaxm_d[fmaxm.d] writes larger of _fs1_ and _fs2_ to _fd_. It is defined like xref:insts:fmax_d.adoc#udb:doc:inst:fmax_d[fmax.d] instruction, except
...
Description::
xref:insts:fmin_d.adoc#udb:doc:inst:fmin_d[fmin.d] writes smaller of _fs1_ and _fs2_ to _fd_. For the purposes of this instruction, the value
`-0.0` is considered to be less than the value `+0.0`. If both inputs are NaNs, the result is the
canonical NaN. If only one operand is a NaN, the result is the non-NaN operand. Signaling NaN inputs
set the invalid operation exception flag, even when the result is not NaN.
...
Description::
xref:insts:fminm_d.adoc#udb:doc:inst:fminm_d[fminm.d] writes smaller of _fs1_ and _fs2_ to _fd_. It is defined like xref:insts:fmin_d.adoc#udb:doc:inst:fmin_d[fmin.d] instruction, except
that if either input is NaN, the result is the canonical NaN.
...
Description::
xref:insts:fmsub_d.adoc#udb:doc:inst:fmsub_d[fmsub.d] multiplies the values in _fs1_ and _fs2_, subtracts the value in _fs3_, and writes the final result to _fd_.
...
Description::
xref:insts:fmul_d.adoc#udb:doc:inst:fmul_d[fmul.d] performs the double-precision floating-point multiplication between _fs1_ and _fs2_. It is defined
...
Description::
xref:insts:fmv_d_x.adoc#udb:doc:inst:fmv_d_x[fmv.d.x] moves the double-precision value encoded in `IEEE 754-2008` standard encoding from the integer
...
Description::
xref:insts:fmv_x_d.adoc#udb:doc:inst:fmv_x_d[fmv.x.d] moves the double-precision value in floating-point register _fs1_ to a representation in
...
Description::
xref:insts:fmvh_x_d.adoc#udb:doc:inst:fmvh_x_d[fmvh.x.d] moves bits 63:32 of floating-point register _fs1_ into integer register _xd_. xref:insts:fmvh_x_d.adoc#udb:doc:inst:fmvh_x_d[fmvh.x.d] is used
in conjunction with the existing xref:insts:fmv_x_w.adoc#udb:doc:inst:fmv_x_w[fmv.x.w] instruction to move a double-precision floating-point number to a
...
Description::
xref:insts:fmvp_d_x.adoc#udb:doc:inst:fmvp_d_x[fmvp.d.x] moves a double-precision number from a pair of integer registers into a floating-point
...
Description::
xref:insts:fnmadd_d.adoc#udb:doc:inst:fnmadd_d[fnmadd.d] multiplies the values in _fs1_ and _fs2_, negates the product, subtracts the value in _fs3_, and
...
Description::
`fnsub.d` multiplies the values in _fs1_ and _fs2_, negates the product, adds the value in _fs3_, and
writes the final result to _fd_.
...
Description::
xref:insts:fround_d.adoc#udb:doc:inst:fround_d[fround.d] instruction rounds the double-precision floating-point number in floating-point register
_fs1_ to an integer, according to the rounding mode specified in the instruction's _rm_ field. It then writes
...
Description::
xref:insts:froundnx_d.adoc#udb:doc:inst:froundnx_d[froundnx.d] instruction is defined in the same way as xref:insts:fround_d.adoc#udb:doc:inst:fround_d[fround.d], but it also sets the inexact exception flag if the input
differs from the rounded result and is not NaN. xref:insts:froundnx_d.adoc#udb:doc:inst:froundnx_d[froundnx.d] is encoded like xref:insts:fcvt_d_s.adoc#udb:doc:inst:fcvt_d_s[fcvt.d.s], but with _xs2_ set to 5.
...
Description::
xref:insts:fsd.adoc#udb:doc:inst:fsd[fsd] stores a double-precision value from the floating-point registers to memory. It is guaranteed to execute
...
Description::
xref:insts:fsgnj_d.adoc#udb:doc:inst:fsgnj_d[fsgnj.d] instruction produces a result that takes all bits except the sign bit from _fs1_.
The result's sign bit is taken from _fs2_'s sign bit, and the result is written to the destination
register _fd_. xref:insts:fsgnj_d.adoc#udb:doc:inst:fsgnj_d[fsgnj.d] does not set floating-point exception flags, nor do they canonicalize _NaN_s.
...
Description::
xref:insts:fsgnjn_d.adoc#udb:doc:inst:fsgnjn_d[fsgnjn.d] instruction produces a result that takes all bits except the sign bit from _fs1_.
The result's sign bit is opposite of _fs2_'s sign bit, and the result is written to the destination
register _fd_. xref:insts:fsgnjn_d.adoc#udb:doc:inst:fsgnjn_d[fsgnjn.d] does not set floating-point exception flags, nor do they canonicalize _NaN_s.
...
Description::
xref:insts:fsgnjx_d.adoc#udb:doc:inst:fsgnjx_d[fsgnjx.d] instruction produces a result that takes all bits except the sign bit from _fs1_.
The result's sign bit is the XOR of sign bits of _fs1_ and _fs2_, and the result is written to
the destination register _fd_. xref:insts:fsgnjx_d.adoc#udb:doc:inst:fsgnjx_d[fsgnjx.d] does not set floating-point exception flags, nor do
...
Description::
xref:insts:fsqrt_d.adoc#udb:doc:inst:fsqrt_d[fsqrt.d] computes the square root of _fs1_ and result is written in _fd_. It is defined
...
Description::
xref:insts:fsub_d.adoc#udb:doc:inst:fsub_d[fsub.d] is analogous to xref:insts:fsub_s.adoc#udb:doc:inst:fsub_s[fsub.s] and performs double-precision floating-point subtraction between
_fs1_ and _fs2_ and writes the final result to _fd_.
