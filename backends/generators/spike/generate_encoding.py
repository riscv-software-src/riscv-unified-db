#!/usr/bin/env python3
"""
Generator script for Spike simulator's encoding header.
This script uses the existing generator.py functions to create encoding.h for Spike.
"""
import os
import sys
import logging
...
def main():
    """
    Main function to generate encoding.h for Spike.
    """
    import argparse

    # Set up command line arguments
    parser = argparse.ArgumentParser(
        description="Generate RISC-V encoding header for Spike"
    )
    parser.add_argument(
        "--inst-dir",
        default="../../../arch/inst/",
