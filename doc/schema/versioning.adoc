...
This is similar to https://semver.org/[Semantic Versioning], though *UDB versions are _not_ semantic* since RISC-V International does not use semantic versioning.
