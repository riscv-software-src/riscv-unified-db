...
#   }
#
# source://rubyzip//lib/zip/filesystem.rb#36
module Zip::FileSystem
  # source://rubyzip//lib/zip/filesystem.rb#37
  def initialize; end
  ...
  # invoked
  #
  # source://rubyzip//lib/zip/filesystem.rb#48
  def dir; end
...
#
# source://rubyzip//lib/zip/filesystem.rb#561
class Zip::FileSystem::ZipFileNameMapper
  include ::Enumerable

  # @return [ZipFileNameMapper] a new instance of ZipFileNameMapper
  #
  # source://rubyzip//lib/zip/filesystem.rb#564
  def initialize(zip_file); end

  # Turns entries into strings and adds leading /
  # and removes trailing slash on directories
  #
  # source://rubyzip//lib/zip/filesystem.rb#615
  def each; end

  # source://rubyzip//lib/zip/filesystem.rb#621
  def expand_path(path); end

  # source://rubyzip//lib/zip/filesystem.rb#571
  def find_entry(filename); end

  # source://rubyzip//lib/zip/filesystem.rb#575
  def get_entry(filename); end

  # source://rubyzip//lib/zip/filesystem.rb#579
  def get_input_stream(filename, &a_proc); end

  # source://rubyzip//lib/zip/filesystem.rb#583
  def get_output_stream(filename, permissions = T.unsafe(nil), &a_proc); end

  # source://rubyzip//lib/zip/filesystem.rb#589
  def glob(pattern, *flags, &block); end

  # source://rubyzip//lib/zip/filesystem.rb#609
  def mkdir(filename, permissions = T.unsafe(nil)); end

  # Returns the value of attribute pwd.
  #
  # source://rubyzip//lib/zip/filesystem.rb#569
  def pwd; end
  ...
  # source://rubyzip//lib/zip/filesystem.rb#593
  def read(filename); end

  # source://rubyzip//lib/zip/filesystem.rb#597
  def remove(filename); end

  # source://rubyzip//lib/zip/filesystem.rb#601
  def rename(filename, new_name, &continue_on_exists_proc); end

  private

  # source://rubyzip//lib/zip/filesystem.rb#630
...
#
# source://rubyzip//lib/zip/filesystem.rb#435
class Zip::FileSystem::ZipFsDir
  # @return [ZipFsDir] a new instance of ZipFsDir
  #
  # source://rubyzip//lib/zip/filesystem.rb#436
  def initialize(mapped_zip); end

  # source://rubyzip//lib/zip/filesystem.rb#464
  def chdir(directory_name); end

  # @raise [NotImplementedError]
  #
  # source://rubyzip//lib/zip/filesystem.rb#511
  def chroot(*_args); end

  # source://rubyzip//lib/zip/filesystem.rb#497
  def delete(entry_name); end

  # source://rubyzip//lib/zip/filesystem.rb#472
  ...
  #
  # source://rubyzip//lib/zip/filesystem.rb#440
  def file=(_arg0); end

  # source://rubyzip//lib/zip/filesystem.rb#482
  def foreach(directory_name); end

  # source://rubyzip//lib/zip/filesystem.rb#459
  def getwd; end

  # source://rubyzip//lib/zip/filesystem.rb#478
  def glob(*args, &block); end

  # source://rubyzip//lib/zip/filesystem.rb#507
  def mkdir(entry_name, permissions = T.unsafe(nil)); end

  # source://rubyzip//lib/zip/filesystem.rb#442
  def new(directory_name); end

  # source://rubyzip//lib/zip/filesystem.rb#446
...
# source://rubyzip//lib/zip/filesystem.rb#516
class Zip::FileSystem::ZipFsDirIterator
  include ::Enumerable

  # @return [ZipFsDirIterator] a new instance of ZipFsDirIterator
  #
  # source://rubyzip//lib/zip/filesystem.rb#519
  def initialize(filenames); end

  # source://rubyzip//lib/zip/filesystem.rb#524
  def close; end

  # @raise [IOError]
  #
  # source://rubyzip//lib/zip/filesystem.rb#528
  def each(&a_proc); end

  # @raise [IOError]
  #
  # source://rubyzip//lib/zip/filesystem.rb#534
  def read; end

  # @raise [IOError]
  #
  # source://rubyzip//lib/zip/filesystem.rb#540
  def rewind; end

  # @raise [IOError]
  #
  # source://rubyzip//lib/zip/filesystem.rb#546
  def seek(position); end

  # @raise [IOError]
  #
  # source://rubyzip//lib/zip/filesystem.rb#552
  def tell; end
end
...
#
# source://rubyzip//lib/zip/filesystem.rb#65
class Zip::FileSystem::ZipFsFile
  # @return [ZipFsFile] a new instance of ZipFsFile
  #
  # source://rubyzip//lib/zip/filesystem.rb#171
  def initialize(mapped_zip); end

  # source://rubyzip//lib/zip/filesystem.rb#326
  def atime(filename); end

  # source://rubyzip//lib/zip/filesystem.rb#304
  def basename(filename); end

  # @return [Boolean]
  #
  # source://rubyzip//lib/zip/filesystem.rb#348
  def blockdev?(_filename); end

  # @return [Boolean]
  #
  # source://rubyzip//lib/zip/filesystem.rb#352
  def chardev?(_filename); end

  # source://rubyzip//lib/zip/filesystem.rb#277
  def chmod(mode, *filenames); end

  # source://rubyzip//lib/zip/filesystem.rb#267
  def chown(owner, group, *filenames); end

  # source://rubyzip//lib/zip/filesystem.rb#335
  def ctime(filename); end

  # source://rubyzip//lib/zip/filesystem.rb#408
  def delete(*args); end
  ...
  #
  # source://rubyzip//lib/zip/filesystem.rb#66
  def dir=(_arg0); end

  # @return [Boolean]
  #
  # source://rubyzip//lib/zip/filesystem.rb#236
  def directory?(filename); end

  # source://rubyzip//lib/zip/filesystem.rb#300
  def dirname(filename); end

  # @return [Boolean]
  #
  # source://rubyzip//lib/zip/filesystem.rb#211
  ...
  # @return [Boolean]
  #
  # source://rubyzip//lib/zip/filesystem.rb#192
  ...
  # source://rubyzip//lib/zip/filesystem.rb#424
  def expand_path(path); end

  # @return [Boolean]
  #
  # source://rubyzip//lib/zip/filesystem.rb#295
  def file?(filename); end

  # source://rubyzip//lib/zip/filesystem.rb#404
  def foreach(filename, sep = T.unsafe(nil), &a_proc); end

  # source://rubyzip//lib/zip/filesystem.rb#364
  ...
  # source://rubyzip//lib/zip/filesystem.rb#312
  def join(*fragments); end

  # @raise [NotImplementedError]
  #
  # source://rubyzip//lib/zip/filesystem.rb#376
  def link(_filename, _symlink_name); end

  # @raise [Errno::ENOENT]
  #
  # source://rubyzip//lib/zip/filesystem.rb#384
  def lstat(filename); end

  # source://rubyzip//lib/zip/filesystem.rb#322
  def mtime(filename); end

  # source://rubyzip//lib/zip/filesystem.rb#253
  def new(filename, mode = T.unsafe(nil)); end

  # source://rubyzip//lib/zip/filesystem.rb#241
  ...
  # @raise [NotImplementedError]
  #
  # source://rubyzip//lib/zip/filesystem.rb#380
  def pipe; end

  # @return [Boolean]
  #
  # source://rubyzip//lib/zip/filesystem.rb#344
  def pipe?(_filename); end

  # source://rubyzip//lib/zip/filesystem.rb#400
  def popen(*args, &a_proc); end

  # source://rubyzip//lib/zip/filesystem.rb#396
  def read(filename); end

  # @return [Boolean]
  #
  # source://rubyzip//lib/zip/filesystem.rb#201
  ...
  # source://rubyzip//lib/zip/filesystem.rb#392
  def readlines(filename); end

  # @raise [NotImplementedError]
  #
  # source://rubyzip//lib/zip/filesystem.rb#368
  def readlink(_filename); end

  # source://rubyzip//lib/zip/filesystem.rb#418
  def rename(file_to_rename, new_name); end

  # @return [Boolean]
  #
  # source://rubyzip//lib/zip/filesystem.rb#220
  def setgid?(filename); end

  # @return [Boolean]
  #
  # source://rubyzip//lib/zip/filesystem.rb#216
  def setuid?(filename); end

  # source://rubyzip//lib/zip/filesystem.rb#257
  ...
  # @return [Boolean]
  #
  # source://rubyzip//lib/zip/filesystem.rb#262
  def size?(filename); end

  # @return [Boolean]
  #
  # source://rubyzip//lib/zip/filesystem.rb#360
  def socket?(_filename); end

  # source://rubyzip//lib/zip/filesystem.rb#308
  ...
  # @return [Boolean]
  #
  # source://rubyzip//lib/zip/filesystem.rb#224
  def sticky?(filename); end

  # @raise [NotImplementedError]
  #
  # source://rubyzip//lib/zip/filesystem.rb#372
  def symlink(_filename, _symlink_name); end

  # @return [Boolean]
  #
  # source://rubyzip//lib/zip/filesystem.rb#356
  def symlink?(_filename); end

  # @raise [StandardError]
  #
  # source://rubyzip//lib/zip/filesystem.rb#232
  def truncate(_filename, _len); end

  # source://rubyzip//lib/zip/filesystem.rb#228
  def umask(*args); end

  # source://rubyzip//lib/zip/filesystem.rb#408
  def unlink(*args); end

  # source://rubyzip//lib/zip/filesystem.rb#316
  def utime(modified_time, *filenames); end

  # @return [Boolean]
  #
  # source://rubyzip//lib/zip/filesystem.rb#206
  ...
  # @return [Boolean]
  #
  # source://rubyzip//lib/zip/filesystem.rb#288
  def zero?(filename); end

  private

  # source://rubyzip//lib/zip/filesystem.rb#175
  def get_entry(filename); end

  # source://rubyzip//lib/zip/filesystem.rb#184
  def unix_mode_cmp(filename, mode); end
end

# protected :dir
#
# source://rubyzip//lib/zip/filesystem.rb#69
class Zip::FileSystem::ZipFsFile::ZipFsStat
  # @return [ZipFsStat] a new instance of ZipFsStat
  #
  # source://rubyzip//lib/zip/filesystem.rb#82
  def initialize(zip_fs_file, entry_name); end

  # source://rubyzip//lib/zip/filesystem.rb#74
  def atime; end

  # source://rubyzip//lib/zip/filesystem.rb#157
  def blksize; end

  # source://rubyzip//lib/zip/filesystem.rb#74
  def blockdev?; end

  # source://rubyzip//lib/zip/filesystem.rb#96
  def blocks; end
  ...
  # source://rubyzip//lib/zip/filesystem.rb#127
  def dev; end
  ...
  # source://rubyzip//lib/zip/filesystem.rb#143
  def ftype; end

  # source://rubyzip//lib/zip/filesystem.rb#105
  def gid; end

  # source://rubyzip//lib/zip/filesystem.rb#74
  def grpowned?; end

  # source://rubyzip//lib/zip/filesystem.rb#123
  def ino; end

  # @return [Boolean]
  #
  # source://rubyzip//lib/zip/filesystem.rb#87
  def kind_of?(type); end

  # source://rubyzip//lib/zip/filesystem.rb#161
  def mode; end

  # source://rubyzip//lib/zip/filesystem.rb#74
  def mtime; end

  # source://rubyzip//lib/zip/filesystem.rb#153
  def nlink; end
  ...
  # source://rubyzip//lib/zip/filesystem.rb#131
  def rdev; end

  # source://rubyzip//lib/zip/filesystem.rb#135
  def rdev_major; end

  # source://rubyzip//lib/zip/filesystem.rb#139
  def rdev_minor; end
  ...
  # source://rubyzip//lib/zip/filesystem.rb#114
  def uid; end
  ...
  # source://rubyzip//lib/zip/filesystem.rb#100
  def get_entry; end

  class << self
    # source://rubyzip//lib/zip/filesystem.rb#71
