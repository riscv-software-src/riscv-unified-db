...
class RuboCop::Cop::Naming::BlockForwarding < ::RuboCop::Cop::Base
  # source://rubocop/1.80.2/lib/rubocop/cop/naming/block_forwarding.rb#68
  def on_def(node); end
  ...
  # source://rubocop/1.80.2/lib/rubocop/cop/naming/block_forwarding.rb#118
  def anonymous_block_argument?(node); end

  # source://rubocop/1.80.2/lib/rubocop/cop/naming/block_forwarding.rb#101
  def block_argument_name_matched?(block_pass_node, last_argument); end

  # source://rubocop/1.80.2/lib/rubocop/cop/naming/block_forwarding.rb#150
  def block_forwarding_name; end

  # source://rubocop/1.80.2/lib/rubocop/cop/naming/block_forwarding.rb#91
  def expected_block_forwarding_style?(node, last_argument); end

  # source://rubocop/1.80.2/lib/rubocop/cop/naming/block_forwarding.rb#122
  def explicit_block_argument?(node); end

  # source://rubocop/1.80.2/lib/rubocop/cop/naming/block_forwarding.rb#110
  def invalidates_syntax?(block_pass_node); end

  # source://rubocop/1.80.2/lib/rubocop/cop/naming/block_forwarding.rb#126
  def register_offense(block_argument, node); end

  # source://rubocop/1.80.2/lib/rubocop/cop/naming/block_forwarding.rb#142
  def use_block_argument_as_local_variable?(node, last_argument); end

  # source://rubocop/1.80.2/lib/rubocop/cop/naming/block_forwarding.rb#114
