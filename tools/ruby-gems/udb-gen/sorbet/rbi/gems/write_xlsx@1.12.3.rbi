...
class Writexlsx::ImageProperty
  # @return [ImageProperty] a new instance of ImageProperty
  #
  ...
  # Sets the attribute ref_id
  #
  # @param value the value to set the attribute ref_id to.
  #
  # source://write_xlsx//lib/write_xlsx/image_property.rb#10
...
class Writexlsx::InsertedChart
  ...
  # @return [InsertedChart] a new instance of InsertedChart
  #
