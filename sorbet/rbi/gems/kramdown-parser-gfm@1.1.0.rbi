...
module Kramdown::Options
  class << self
    # source://kramdown/2.5.1/lib/kramdown/options.rb#72
    def defaults; end

    # source://kramdown/2.5.1/lib/kramdown/options.rb#51
    def define(name, type, default, desc, &block); end

    # source://kramdown/2.5.1/lib/kramdown/options.rb#67
    def defined?(name); end

    # source://kramdown/2.5.1/lib/kramdown/options.rb#62
    def definitions; end

    # source://kramdown/2.5.1/lib/kramdown/options.rb#83
    def merge(hash); end

    # source://kramdown/2.5.1/lib/kramdown/options.rb#97
    def parse(name, data); end

    # source://kramdown/2.5.1/lib/kramdown/options.rb#142
    def simple_array_validator(val, name, size = T.unsafe(nil)); end

    # source://kramdown/2.5.1/lib/kramdown/options.rb#159
    def simple_hash_validator(val, name); end

    # source://kramdown/2.5.1/lib/kramdown/options.rb#123
